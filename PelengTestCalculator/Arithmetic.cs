...
namespace PelengTestCalculator
{
    public static class Arithmetic
    {
        ...
        public static double Sub(params double[] args)
        {
            ...
            throw new ArgumentException("Uncorrect number of arguments for subtraction");
        }
        ...
        public static double Div(params double[] args)
        {
            ...
            throw new ArgumentException("Uncorrect number of arguments for division");
        }
        ...
        public static double Sin(params double[] args)
        {
            ...
            throw new ArgumentException("Uncorrect number of arguments for sinus");
        }
        ...
        public static double Cos(params double[] args)
        {
            ...
            throw new ArgumentException("Uncorrect number of arguments for cosinus");
        }
        ...
        public static double Atan2(params double[] args)
        {
            ...
            throw new ArgumentException("Uncorrect number of arguments for atan2");
        }
